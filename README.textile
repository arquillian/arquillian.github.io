...
* inline code block broken in guides
...
* port http://localhost:4242/blog/2010/07/03/ike-a-developer-magnet-at-judcon-jboss-world
* use image-url() in stylesheet
* make sure homepage loads fast
...
* add share buttons in footer (facebook, google+, etc) (see http://dandypixels.com/sharecount/#howto)
* html5 icon in footer
* use news icon in place of RSS icon for subscribing to blog
* finish porting blogs
* release blog additions
** list of contributors
** maven coordinates/link
** comments from jira release
* guides
