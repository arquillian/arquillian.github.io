...
* author (the original author of the guide)
...
* link Invasion Team images to github, jboss community, twitter, etc
* jpa guide
* blog for 1.0 release
* edit Duke's Choice Award blog
* incorporate Max's changes to getting started guide
* layout for community press page, perhaps like diigo displays it (no table!)
* don't hardcode events on home page (or at least update them for now)
* mention QE team on Team page
* finish screenshots for community page (like torquebox.org/community)
* each feature should link to "show this feature in tutorial" (missing a few)
* float module info in release blog to right
* google analytics setup (pending aslak commit)
* how to link to release notes from anywhere (interwiki link)
...
* code section
** latest JIRA issues added/fixed/updated
** latest commits 
** ohloh badge
* Sarah
** compass sprites, how to do them, start creating
** l&f of module pages (versions & version matrix, contributor grid)
...
* double save to preview page problem (assign to: aslak)
...
* use :no_span_caps in Awestruct (or honor config option in pipeline)
...
* Events from lanyrd (need to pull ical, then process) (aslak)
* Nobles extension from config
* interwiki links (like JIRA, Github resource, etc)
* Fork me on github ribbon
* Guides similar to the Posts extension (make into reusable extension)
