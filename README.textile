...
* translate bookend content for guides (share the knowledge section, toc header)
* cross check http://community.jboss.org/wiki/ArquillianProjectTODO for tasks still needed to be done
* make use of .awestruct_ignore
* Toggle code snippets like on dartlang.org
* Change navigation link order to: Invasion | Features | Guides | Blog | Community | Code
...
* smooth scroll not working in zh_cn
...
* use "Guide" in title of page to key search engines
