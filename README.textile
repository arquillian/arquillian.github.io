...
* send pull request for tag group calculation fix
...
** disable link if no blog or twitter ref
* links to migration guides? perhaps on core module page?
...
* fix casing on container module names (e.g, Jbossas)
