...
p. Simply name your file using following convention @[artifactId]-[versionId].textile@ (eg. @arquillian-core-1.0.0.CR6.textile@). Fill in the most important features which are part of this particular release.
...
* translator field for guides
* Toggle code snippets like on dartlang.org
* Navigation link order: Invasion Features Guides Blog Community Code
...
* guides
** eclipse-only example in guides
** dependency resolver!!!
...
* multiple headings on same page in guide breaks the sidebar highlighting
...
* do pages post to Google+ correctly (with proper description)
