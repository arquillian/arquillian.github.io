...
* instructions for writing a guide
* endless regeneration when offline?
* drone guide
* make slideshow frame wider on home page
...
* change layout of community press page, perhaps like diigo displays it (no table!)
* get footer to stick to bottom of page on short pages
* link The Invaders images to github, jboss community, twitter, etc
...
* double save to preview page problem
