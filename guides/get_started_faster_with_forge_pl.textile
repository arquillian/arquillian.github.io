...
bc(command). $ arquillian setup --containerType MANAGED --containerName JBOSS_AS_MANAGED_7.X
...
bc(command). $ arquillian configure-container --profile arq-jboss_as_managed_7.x
...
bc(command). $ build test --profile arq-jboss_as_managed_7.x
