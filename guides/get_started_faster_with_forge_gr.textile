...
Αν ανοίξεις το jar αρχείο χρησιμοπιώντας ένα archive πρόγραμμα, θα δεις ότ ταιριάζει με το ShrinkWrap archive που όρισες στην @@Deployment@ μέθοδο του τέστ.
