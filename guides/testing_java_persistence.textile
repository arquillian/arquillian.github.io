...
authors: ['Dan Allen', 'Bartosz Majsak']
...
public void shouldFindAllGamesUsingCriteriaApi() throws Exception {
	...
	// Toggle comment on first orderBy criteria below (and comment the
	// subsequent line)
	// if you want to try out type-safe criteria queries, a new feature in
	// JPA 2.0
