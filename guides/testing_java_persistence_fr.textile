...
Nous définissons la Persistence Unit dans un fichier test-persistence.xml correspondant au conteneur cible. Shrinkwrap prend ce fichier dans le classpath et le place à l'endroit standard dans l'archive. 
