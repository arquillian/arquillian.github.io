...
You can set the JBoss AS 7 installation path explicitly by setting the value of the @jbossHome@ property in arquillian.xml to the location where JBoss AS 7 is installed. Forge can help us out with that:
...
bc(output).. Which property do you want to set?
 ...
 ? What value do you want to set? /home/paul/applications/jboss-as
Wrote /home/paul/projects/arquillian-demo/src/test/resources/arquillian.xml
