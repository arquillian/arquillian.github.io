...
- If you answer @y@: := Forge will ask you where you want to install JBoss AS 7 (e.g., /home/paul/applications). Forge then configures the Maven dependency plugin to download and unpack AS 7 to that location (if it's not already there) before the tests are run.
...
bc(output).. Which property do you want to set?
 ...
 ? What value do you want to set? /home/paul/applications/jboss-as-7.1.1.Final
...
bc(prettify). <arquillian xmlns="http://jboss.org/schema/arquillian"
    ...
    <container qualifier="JBOSS_AS_MANAGED_7.X">
        <configuration>
            <property name="jbossHome">/home/paul/applications/jboss-as-7.1.1.Final</property>
        </configuration>
    </container>
</arquillian>
