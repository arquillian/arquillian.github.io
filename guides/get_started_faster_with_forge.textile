...
Before we can get started with Arquillian we need a project. If you have not created one yet, use the following Forge commands to create a simple Java EE 6 project that includes CDI.
...
Wrote /home/dallen/projects/arquillian/tutorials/arquillian-demo/pom.xml
