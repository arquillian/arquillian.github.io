...
This guide assumes you have Maven available, either in your command shell or your IDE(Integrated Development Environment). If you don't, please "install it now":http://maven.apache.org/download.html.
...
# Download and unzip Forge into a folder on your harddrive; this folder will be your @$FORGE_HOME@
# Add '$FORGE_HOME/bin' to your path (Windows, Linux, or Mac OSX)

On Unix based operating systems, adding Forge to your path typically means editing your ~/.bashrc or ~/.profile; you will need to the following entries:

bc. export FORGE_HOME=~/forge/
