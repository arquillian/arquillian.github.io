...
p. Next you need to set the right system property in order to change the Arquillian settings for browser selection. Add the following to the @pom.xml@:
