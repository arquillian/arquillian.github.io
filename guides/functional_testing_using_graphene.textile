...
authors: [mojavelinux, kpiwko, jhuska, lfryc, bleathem, matousjobanek]
...
p. You have to specify the dependency on a container adapter. We will use the "WildFly":http://wildfly.org/ 10 remote container, because it is an effective way to develop tests. You can read more about that in the blog "rapid test development turnaround":http://lukas.fryc.eu/blog/2013/06/testing-jsf-richfaces-arquillian-2-rapid-test-development.html (the section "Remote Servers").
