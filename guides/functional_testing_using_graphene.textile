...
p(important). %If you happen to use Maven prior 3.0.5 and you can't upgrade, you'll need to enfore @maven-resource-plugin@ to version 2.5 or higher in order to filter test resources correctly. You can do that by specifying the plugin version in <pluginManagement> of your @pom.xml@ file.%
