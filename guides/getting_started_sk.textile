...
Najjednoduchší spôsob, ako začať s Arquillianom, je jeho začlenenie do testovacej infraštruktúry projektu, ktorý ponúka riadenie závislostí. Najrozšírenejším nástrojom v tejto kategórii je "Apache Maven":maven_home. Tento návod vás prevedie vaším prvým *(greenbar)úspešným testom* používajúc nový Maven projekt.
