...
Il generatore del progetto ha creato anche un package Java con nome @org.arquillian.example@ sotto le due directory @java@. Quì dovremo mettere tutti i sorgenti Java invece della root @java@.
...
Creiamo un test JUnit in src/test/java con nome @GreeterTest@ e assegnamogli un package con nome @org.arquillian.example@. Non ci sarà bisogno dei tipici metodi JUnit di setup e tearDown dal momento che tutto sarà gestito da Arquillian. Quì in basso c'è tutto quello di cui abbiamo bisogno:
...
Per uno sguardo più approfondito su Arquillian, possiamo passare alla guida "Guida Introduttiva: Rispolveriamo e Ripetiamo":/guides/getting_started_rinse_and_repeat. Per vedere come Forge automatizza la configurazione di Arquillian e genera i test, passiamo alla guida "Rapida Guida Introduttiva a Forge":/guides/get_started_faster_with_forge.
