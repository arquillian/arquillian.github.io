...
tags: [openshift, as7]
guide_summary: Execute your tests in the cloud on OpenShift Express.
guide_group: 2
guide_order: 4
---
...
* Configure your build and Arquillian to use the OpenShift Express container adapter
* Run your Arquillian tests in the cloud (on OpenShift Express)

h3. Assumptions

We'll assume that you've read the "Getting Started":/guides/getting_started guide and the "Functional Testing":/guides/functional_testing_using_drone. This tutorial builds on the applications that you built in those tutorials.
