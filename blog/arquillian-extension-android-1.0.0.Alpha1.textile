...
p. First, download Android SDK from "developer.android.com":http://developer.android.com/sdk/index.html and point ANDROID_HOME system variable to directory where you extracted it. You should also update it via running `android` and navigating in the GUI.
...
p. Download Android Server APK to be installed to you mobile device from "code.google.com":http://code.google.com/p/selenium/downloads/list. Use *android-server-2.6.0.apk* for devices including Android 2.3.4, latest version for Android 3.0 and newer. 
