...
Arquillian Droidium 1.0.0.Alpha5 is the last Alpha release before reaching Beta stage. Starting with Beta1, you can expect experimental support for Arquillian Drone 2.0.0.Alpha1, removal of web pluging which depends on the deprecated Selenium Android server APK, that will be replaced by the Selendroid's Android driver. It will also be updated to use Selenium 2.40 from current 2.39.
