...
Thanks to the amazing effort of "Juraj Húska":https://github.com/jhuska, we were able to rewrite the original "Functional Testing using Drone":/guides/functional_testing_using_drone/ guide to use Graphene 2. Even though it is targetting beginners of the Selenium WebDriver API, it will teache you best practices so you can write maintainable and efficient functional tests from day one.
=:
