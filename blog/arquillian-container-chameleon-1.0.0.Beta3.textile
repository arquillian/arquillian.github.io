...
p. We brought support for latest @GlassFish@ 5 server, you can use it as follows:

* glassfish:5.0:managed
* glassfish:5.0:remote

p. In addition we depracated support for GlassFish 4.0 in favor of GlassFish 4.1.
