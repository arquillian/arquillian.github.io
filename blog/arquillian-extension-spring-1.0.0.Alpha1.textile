...
p. For more examples on how to use these extensions and quickly get started with development you can take a look at prepared "showcases":https://github.com/arquillian/arquillian-showcase/spring. Additionally you browse the "integration tests":https://github.com/arquillian/arquillian-container-spring that are part of project source code.
