...
p. New flag has been added to enable/disable the detection of OpenShift Image Streams. These files must be located at @target@ directory and thir name end with @-is.yml@.
