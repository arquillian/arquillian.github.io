...
p. In this release we ship more support to JUnit 5. Concretely we have added support for @@org.junit.jupiter.api.Tag@ and @@org.junit.jupiter.api.Tags@ in @categorized@ strategy.
