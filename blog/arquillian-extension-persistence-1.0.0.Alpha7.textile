...
- <i class="icon-star"></i> SQL script handling improvments :=
SQL script handling has been significantly imporoved. It not only has improved performance (namely for Oracle) but also let you provide your own implementation for parsing multi-line scripts through simple SPI @org.jboss.arquillian.persistence.spi.script.StatementSplitter@. 
=:
