...
p. This release of Arquillian Cube Q contains one new, but important feature, that allows you to add some randomness on some toxics values, using mathematical distributions. Currently "uniform distribution":https://en.wikipedia.org/wiki/Uniform_distribution_(continuous) and "log-normal distribution":https://en.wikipedia.org/wiki/Log-normal_distribution are supported.
