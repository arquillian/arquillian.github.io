...
author: Dan Allen
tags: [ arquillian, community, recognition, contributors, awards, announcement ]
---
...
The "Arquillian Nobles page":http://arquillian.org/community/nobles on the project site lists the recipients along with the contributions they made. Contributors are awarded for either a specific release, or for general support of the project. The names of the community members crowned so far are listed here (for reference):

!>/images/arquillian_crown_icon_glossy_256.png!
...
In addition to being listed on the "Arquillian Nobles":http://arquillian.org/community/nobles page, we are working to get a crown added to each recipient's JBoss Community profile so that it is globally visible. We'll announce when that's available.
