...
p. Notice the @@Root@ annotation. The value for that field is automatically injected by Graphene to reference all defined @@FindBy@ elements from it. Such implementation is pretty generic and therefore reusable in all tests for different applications.
