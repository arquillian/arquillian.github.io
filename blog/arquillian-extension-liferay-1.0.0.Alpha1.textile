...
* https://github.com/liferay/liferay-apps-content-targeting/tree/master/content-targeting-test
* https://github.com/liferay/liferay-portal/blob/master/modules/portal/portal-json-web-service-extender/test/integration/com/liferay/portal/json/web/service/extender/test/JSONWebServiceTrackerTest.java
...
This extension is independent of the container. You can find instructions to configure a tomcat server to accept tests for legacy plugins here: https://www.liferay.com/web/manuel.delapenya/blog

You can find examples of use here https://github.com/kameshsampath/liferay-arquillian-showcase
