...
You can even close your JIRAs directly from test methods when you force the execution despite the fact it should be skipped. If this test method passes successfuly, you can close related JIRA issue from test. Let's see it in action:
