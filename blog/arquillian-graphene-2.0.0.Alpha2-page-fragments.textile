...
h3. Could you please ask yourself the following questions.
...
p. Well, in my opinion all these questions should have affirmative answers. You are probably aware of the fact that tests should be loosly coupled with the underlaying HTML structure of the application under test. It makes tests more robust and a likely change in the HTML structure of the page will no more affects tests.
