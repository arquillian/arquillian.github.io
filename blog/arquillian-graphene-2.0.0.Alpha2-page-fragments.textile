...
bc(prettify).. public class TestAutocompleteWidgets extends AbstractTest {
...
Finally following snippet showcases the actual autocomplete widgets tests. Note that extending of the @AbstractTest@ is just illustrating usage, where all Arquillian related stuff, e.g. @Deployment method or method which loads the page in the browser, are declared in.
