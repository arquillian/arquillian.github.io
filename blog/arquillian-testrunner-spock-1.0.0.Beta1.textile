...
h3(highlights). Important changes
 ...
 <i class="icon-star"></i> In order to let Arquillian sneak in to the Spock dimension you'll need to annotate your @Specification@ using @@ArquillianSpecification@.

 <i class="icon-star"></i> We also updated the Spock and Groovy versions. We guarantee that the following combinations won't let you down:
...
You can always take a look at our "examples":https://github.com/arquillian/arquillian-testrunner-spock/tree/master/examples where we show how to use both versions with Maven.
