...
* All content managed by git and hosted on Github
* Baked with "Awestruct":http://awestruct.org, a static site generator
* Data curating pipeline written in Ruby (JRuby) as Awestruct extensions
...
* Guess blogs and improvements accepted via pull requests
...
* Auto-generated, detailed blog entry for each release, with option for custom notes
