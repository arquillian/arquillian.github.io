...
p. We would like to thank everyone who have been involved with the project so far; early adopters, issue reporters, people who improved documentation and of course people who picked up a ball and contributed the code. You all hardened the project to the shape it is now.

p. **Thank you, you guys rock!**

h3. How Graphene compares to WebDriver?

p. It’s important to say that Graphene is not just another dialect for WebDriver as we fully support the original WebDriver Java API. Instead, we add sensitive API extensions which we believe altogether improves the experience and emphasizes ease of use - the common requirement for mass adoption.

p. We take the best of WebDriver such as

* wide browser support,
* object-oriented API,
* design patterns such as Page Objects,
...
p. Graphene adds to this the concept of Page Fragments, which allows you to make even better abstractions. "Page Fragments":/blog/2012/09/19/introducting-arquillian-graphene-page-fragments/ are so cool that e.g. the RichFaces project plan to offer fragments for testing their own widgets, in order to make your life super-easy.
...
p. If you’re new to functional testing, I recommend you starting by reading "Functional Testing using Drone and Graphene":/guides/functional_testing_using_graphene/ which will guide you from; the first build setup; packaging parts of your application as a testable deployment and finally how to write your first test using Arquillian Graphene. It will give you an idea of how to structure the tests and give a few tips on how to write the tests reliably.

p. Then you should focus on learning the "WebDriver API":https://code.google.com/p/selenium/wiki/GettingStarted.

p. If you already know the WebDriver API, I recommend reading through the "Reference Documentation":https://docs.jboss.org/author/display/ARQGRA2/Home which contain descriptions of all the features. Plus a few tips and tricks.
