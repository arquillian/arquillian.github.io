...
p. New version of Arquillian Cube 1.0.0.Alpha20 has been released with bug fixing and new feature!

h3. What's new

p. <i class="icon-star"></i> **Arquillian Cube Container Object DSL**

p. A new option to start/stop containers is using a generic container objects provided by Arquillian Cube to define cube instances.
...
p. You can also create networks in similar programmatic way:
