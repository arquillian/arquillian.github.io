...
New release and probably last Alpha of Arquillian Cube.

Apart from bug fixes and components upgrades that you can inspect in issues list, this release also contains a lot of new feature:
...
p. You can read more about Arquillian Recorder integration at http://arquillian.org/arquillian-cube/#_arquillian_recorder_reporter_integration
...
p. You can read more about manual attribute at http://arquillian.org/arquillian-cube/#_configuration
...
p. You can read more about Arquillian Drone integration at http://arquillian.org/arquillian-cube/#_drone

=:

- <i class="icon-star"></i> Integration with Arquillian Graphene :=

p. Arquillian Graphene is a wrapper above Arquillian Drone to provide a simplification in Page Object patter, AJAX testing or High Level find elements.
...
p. You can read more about Arquillian Graphene integration at http://arquillian.org/arquillian-cube/#_graphene
...
p. You can read more about this feature at http://arquillian.org/arquillian-cube/#_parallel_execution
...
p. You can read more about this feature at http://arquillian.org/arquillian-cube/#_requirements_module
...
p. You can read more about RestAssured integration at http://arquillian.org/arquillian-cube/#_rest_assured_integration
